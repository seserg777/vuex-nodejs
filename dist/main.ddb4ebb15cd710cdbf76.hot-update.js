...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    load() {
      axios__WEBPACK_IMPORTED_MODULE_0___default().get(`${this.SERVICE_URL}/api/profiles/home/npo`)
      .then((response) => {
        this.serviceProviders = response.data.data;
      });
    }
  }
  //https://62d4757a5112e98e484fa7f0.mockapi.io
});
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return " Hello " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.user)
}
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("0ee91eb8520c55074b90")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.ddb4ebb15cd710cdbf76.hot-update.js.map